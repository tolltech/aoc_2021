    ...
    public class Task01
    {
        ...
        public void Task(int[] input, int expected)
        {
            ...
            for (var j = 0; j < input.Length; ++j)
            {
                ...
                {
                    (input[i] * input[j]).Should().Be(expected);
                    return;
                }
            }
